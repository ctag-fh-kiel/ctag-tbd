...
.. list-table::
   ...
   * - **Codec**
     - `TLV320AIC3254IRHBR <https://www.ti.com/product/en-us/TLV320AIC3254/part-details/TLV320AIC3254IRHBR>`_
   * - **Latency**
...
- **USB-C #1** --- ESP32-P4 Device (High Speed): USB MIDI, USB Network
...
- **USB-A** --- USB Host Port for MIDI controllers and other peripherals
