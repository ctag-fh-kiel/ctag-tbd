...
.. raw:: html
   ...
   <img src="../_static/assets/dadamachines-tbd-16_mockup.jpg" alt="dadamachines TBD-16" style="max-width: 100%; width: 100%; border-radius: 6px;">
...
.. list-table::
   ...
   * - **ESP32-P4**
     - DSP Engine
     - Dual RISC-V @ 400 MHz
     - 32 MB stacked PSRAM · 16 MB Flash · AI/vector instructions · USB 2.0 OTG · H.264 encode/decode
   * - **RP2350B**
     - UI / MIDI
     - Dual Arm Cortex-M33 @ 150 MHz
     - 520 KB SRAM · 48 GPIO · 8× 12-bit ADC · 12× PIO state machines · FPU + DSP instructions · hardware security (TrustZone, TRNG, OTP)
   * - **ESP32-C6**
     - WiFi
     - Single RISC-V
     - WiFi 6 (802.11ax) · Bluetooth 5 · managed by the P4

The P4 and RP2350B communicate via SPI. The RP2350B sends control data (knobs, buttons,
