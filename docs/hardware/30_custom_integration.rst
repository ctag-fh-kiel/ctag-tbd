...
Instead of using a pre-built module, you integrate the ESP32-P4, RP2350, audio codec,
and supporting components directly into your product's circuit board --- giving you
complete freedom over form factor, connectors, cost optimization, and production scaling.
...
.. list-table::
   ...
   * - **Audio codec**
     - ADC/DAC for professional-grade audio I/O
   * - **Power management**
...
- **Custom I/O** --- Choose your own connectors, jack types, control count
