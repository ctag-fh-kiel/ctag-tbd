...
`https://github.com/dadamachines/dada-tbd-app-template <https://github.com/dadamachines/dada-tbd-app-template>`_
...
4. Compile and flash via BOOTSEL mode or the :doc:`App Manager </flash/60_app_manager>`.
