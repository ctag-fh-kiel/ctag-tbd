...
def endpoint_from_function(func: tbr.FunctionDescription, attr_names: list[str]) -> tuple[str, Endpoint] | None:
    ...
    handler_attrs = [attr for attr in func.attrs if attr.name in attr_names]
