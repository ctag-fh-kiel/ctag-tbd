...
public:
    ...
    virtual void processreplace(_fv3_float_t *samples, int32_t numsamples);
...
protected:
    ...
    CTAG::SP::HELPERS::ctagPNoiseGen noise1L;
    const static int32_t allpCo[FV3_STREV_NUM_ALLPASS], delayCo[FV3_STREV_NUM_DELAY], idxLCo[FV3_STREV_NUM_INDEX], idxRCo[FV3_STREV_NUM_INDEX];
    const static int32_t allpM_EXCURSION;
    int32_t iLC[FV3_STREV_NUM_INDEX], iRC[FV3_STREV_NUM_INDEX], tankDelay;
};
