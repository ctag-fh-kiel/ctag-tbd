...
class _FV3_(utils)
{
 public:
  ...
  static int32_t ms2sample(_fv3_float_t msec, int32_t fs);
  static int32_t ms2sample(_fv3_float_t msec, _fv3_float_t fs);
  static void mute(_fv3_float_t * f, int32_t t);
  static int32_t checkPow2(int32_t i);
  static bool isPrime(int32_t number);
