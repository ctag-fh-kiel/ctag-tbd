...
public:
  _FV3_(progenitor)() ;
  virtual void mute();
  virtual void processreplace(_fv3_float_t *inputL, _fv3_float_t *inputR, _fv3_float_t *outputL, _fv3_float_t *outputR, int32_t numsamples);
  virtual void processreplace(_fv3_float_t* data, int32_t size);
  /**
 ...
 protected:
  ...
  const static int32_t allpassLCo[FV3_PROGENITOR_NUM_ALLPASS], allpassRCo[FV3_PROGENITOR_NUM_ALLPASS],
