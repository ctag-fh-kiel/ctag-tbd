...
namespace CTAG {
	...
	atomic<int32_t> ab_sus, trig_ab_sus;
	...
	atomic<int32_t> db_sus, trig_db_sus;
	...
	atomic<int32_t> as_sus, trig_as_sus;
	...
	atomic<int32_t> ds_sus, trig_ds_sus;
	...
	atomic<int32_t> hh1_sus, trig_hh1_sus;
	...
	atomic<int32_t> hh2_sus, trig_hh2_sus;
	...
	atomic<int32_t> s1_trigger, trig_s1_trigger;
	...
	atomic<int32_t> s1_loop, trig_s1_loop;
	atomic<int32_t> s1_atk, cv_s1_atk;
	atomic<int32_t> s1_dcy, cv_s1_dcy;
	atomic<int32_t> s2_trigger, trig_s2_trigger;
	...
	atomic<int32_t> s2_loop, trig_s2_loop;
	atomic<int32_t> s2_atk, cv_s2_atk;
	atomic<int32_t> s2_dcy, cv_s2_dcy;
	atomic<int32_t> s3_trigger, trig_s3_trigger;
	...
	atomic<int32_t> s3_loop, trig_s3_loop;
	atomic<int32_t> s3_atk, cv_s3_atk;
	atomic<int32_t> s3_dcy, cv_s3_dcy;
	atomic<int32_t> s4_trigger, trig_s4_trigger;
	...
	atomic<int32_t> s4_loop, trig_s4_loop;
