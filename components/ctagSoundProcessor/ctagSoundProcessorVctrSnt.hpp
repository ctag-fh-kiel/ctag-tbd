...
namespace CTAG {
    namespace SP {
        ...
        private:
            ...
            enum trig_states {e_Gate, e_LfoWTxFadeActive_1, e_LfoWTxFadeActive_2, e_ModSamplesXfade, e_ScanWavTblAauto, e_ScanWavTblCauto, e_FreqModActive,
                              ...
                              e_FreqModExclSubOSC, e_FreqModExclWT, e_FreqModExclSample,
            ...
            enum snh_members {e_XfadeWT_1, e_XfadeWT_2, e_WT_A, e_WT_C, e_PitchMod, e_filterLFO_A, e_filterLFO_C, e_snh_max};
