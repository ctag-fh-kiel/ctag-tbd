#include "ctagSoundProcessorRings.hpp"
#include <iostream>
...
ctagSoundProcessorRings::ctagSoundProcessorRings() {
    setIsStereo();
...
void IRAM_ATTR ctagSoundProcessorRings::Process(const ProcessData &data) {
    updateParams(data);
...
void ctagSoundProcessorRings::updateParams(const ProcessData &data) {
...
const char *ctagSoundProcessorRings::GetCStrID() const {
    return id.c_str();
}


void ctagSoundProcessorRings::setParamValueInternal(const string &id, const string &key, const int val) {
...
void ctagSoundProcessorRings::loadPresetInternal() {
// autogenerated code here
// sectionCpp1
