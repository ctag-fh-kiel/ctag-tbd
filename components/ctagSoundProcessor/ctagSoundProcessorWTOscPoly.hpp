...
namespace CTAG {
    namespace SP {
        class ctagSoundProcessorWTOscPoly : public ctagSoundProcessor {
        public:
            virtual void Process(const ProcessData &) override;
            ctagSoundProcessorWTOscPoly();
            virtual ~ctagSoundProcessorWTOscPoly();
	...
	atomic<int32_t> sustain_1, cv_sustain_1;
	atomic<int32_t> sustain_2, cv_sustain_2;
