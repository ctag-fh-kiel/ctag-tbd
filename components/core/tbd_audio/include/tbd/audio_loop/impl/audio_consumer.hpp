...
#include <tbd/audio_loop/impl/sound_level_worker.hpp>
...
uint32_t AudioConsumer::consume(float* audio_slice) {
    ...
    max = 255.f + 3.2f * tbd::sound_utils::fast_dBV(peakIn); // cut away at approx -80dB
