...
#include <tbd/sounds/SoundProcessorWTOscDuo.hpp>
...
void SoundProcessorWTOscDuo::Init(std::size_t blockSize, void *blockPtr) {
...
SoundProcessorWTOscDuo::~SoundProcessorWTOscDuo() {
}

void SoundProcessorWTOscDuo::prepareWavetables() {
