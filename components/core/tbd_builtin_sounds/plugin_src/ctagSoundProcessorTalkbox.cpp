...
#include <tbd/sounds/SoundProcessorTalkbox.hpp>
...
void SoundProcessorTalkbox::Init(std::size_t blockSize, void *blockPtr) {
    // Talk box
...
SoundProcessorTalkbox::~SoundProcessorTalkbox() {
}
