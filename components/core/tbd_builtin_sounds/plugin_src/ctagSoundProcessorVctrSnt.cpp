...
#include <tbd/sounds/SoundProcessorVctrSnt.hpp>
...
float SoundProcessorVctrSnt::morph_sine_wave(float sine_val, int morph_mode, int enum_sine) {
    switch (morph_mode) {
        case 0:                                       // SINE_WAVE
...
// --- Sample & Hold LFOs ---
float SoundProcessorVctrSnt::applySnH(float sine_lfo_val, int enum_val) {
    if (sine_lfo_val >=
...
void SoundProcessorVctrSnt::prepareWavetable(const int16_t **wavetables, int currentBank, bool *isWaveTableGood,
...
void SoundProcessorVctrSnt::Init(std::size_t blockSize, void *blockPtr) {
    // romplers init
    for(auto &r: romplers)
        r.Init(44100.f);
...
SoundProcessorVctrSnt::~SoundProcessorVctrSnt() {
}
