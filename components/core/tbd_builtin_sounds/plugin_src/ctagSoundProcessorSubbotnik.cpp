...
#include <tbd/sounds/SoundProcessorSubbotnik.hpp>
#include <iostream>
#include <cmath>
...
float SoundProcessorSubbotnik::morph_sine_wave(float sine_val, int morph_mode, int enum_sine)
{
  switch (morph_mode)
  {
    case 0:                                       // SINE_WAVE
...
// --- Sample & Hold LFOs ---
float SoundProcessorSubbotnik::applySnH(float sine_lfo_val, int enum_val)
{
...
void SoundProcessorSubbotnik::Init(std::size_t blockSize, void *blockPtr)
{
...
SoundProcessorSubbotnik::~SoundProcessorSubbotnik()
{
}
