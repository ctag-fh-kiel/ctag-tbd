#include <tbd/sounds/SoundProcessorMonoDelay.hpp>
...
void SoundProcessorMonoDelay::Process(const audio::ProcessData&data) {
	...
	for(int i=0; i<32; i++){
		...
		outputSample = sound_utils::InterpolateWaveLinearWrap(delayBuffer, readPos, 88200);
		readPos += 1.f;
...
void SoundProcessorMonoDelay::Init(std::size_t blockSize, void *blockPtr) {
...
// dtor
SoundProcessorMonoDelay::~SoundProcessorMonoDelay() {
