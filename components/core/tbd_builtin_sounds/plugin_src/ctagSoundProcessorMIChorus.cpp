...
#include <tbd/sounds/SoundProcessorMIChorus.hpp>
#include <iostream>
#include <tbd/sound_utils/ctagFastMath.hpp>

using namespace tbd::sounds;

void SoundProcessorMIChorus::Init(std::size_t blockSize, void *blockPtr) {
...
void SoundProcessorMIChorus::Process(const sound_processor::ProcessData&data) {
...
SoundProcessorMIChorus::~SoundProcessorMIChorus() {
}
