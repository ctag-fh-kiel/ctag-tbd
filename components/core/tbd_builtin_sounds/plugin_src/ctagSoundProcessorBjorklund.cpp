...
#include <tbd/sounds/SoundProcessorBjorklund.hpp>
...
void SoundProcessorBjorklund::Init(std::size_t blockSize, void *blockPtr) {
...
SoundProcessorBjorklund::~SoundProcessorBjorklund() {
}
