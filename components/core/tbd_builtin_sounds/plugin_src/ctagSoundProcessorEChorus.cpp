...
#include <tbd/sounds/SoundProcessorEChorus.hpp>
#include <cmath>
...
void SoundProcessorEChorus::Init(std::size_t blockSize, void *blockPtr) {

}

SoundProcessorEChorus::~SoundProcessorEChorus() {
