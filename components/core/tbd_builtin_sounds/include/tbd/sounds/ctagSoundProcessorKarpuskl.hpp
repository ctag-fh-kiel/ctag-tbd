...
protected:
    ...
    inline float freqToNote(float incoming_frequency) {  return (12.f * sound_utils::fast_log2(incoming_frequency/440.f)+69.0 );  } // Also see: http://newt.phys.unsw.edu.au/jw/notes.html
