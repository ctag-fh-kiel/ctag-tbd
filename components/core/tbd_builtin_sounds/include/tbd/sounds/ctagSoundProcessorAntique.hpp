...
protected:
	sound_utils::ctagWNoiseGen rnd, hissLevelMod;
	sound_utils::ctagWNoiseGen pop1, pop2, click;
	sound_utils::ctagSineSource popSrc;
	sound_utils::ctagDecay popShaper;
	stmlib::Svf clickFilter;
	stmlib::Svf hissFlt, scrubFilt;
	braids::AnalogOscillator humm;
	mifx::PitchShifter fx;
	float *fx_buffer;
	sound_utils::ctagSineSource lfoWow, lfoFlutter, lfoPopBlend;
