...
// --- Utility stuff ---
#include <tbd/sound_utils/ctagRollingAverage.hpp>
...
protected:
    ...
    std::atomic<int32_t> BeatDivider, cv_BeatDivider;
    std::atomic<int32_t> InternalClock, trig_InternalClock;
    std::atomic<int32_t> ClockSpeed, cv_ClockSpeed;
    ...
    std::atomic<int32_t> ScaleCorrect, cv_ScaleCorrect;
    std::atomic<int32_t> Volume, cv_Volume;
    std::atomic<int32_t> SawPitch, cv_SawPitch;
    std::atomic<int32_t> SawTune, cv_SawTune;
    std::atomic<int32_t> PulsePitch, cv_PulsePitch;
    std::atomic<int32_t> PulseTune, cv_PulseTune;
    std::atomic<int32_t> PulseWidth, cv_PulseWidth;
    std::atomic<int32_t> PWMon, trig_PWMon;
    std::atomic<int32_t> PWMspeed, cv_PWMspeed;
    std::atomic<int32_t> PWMamount, cv_PWMamount;
    std::atomic<int32_t> NoiseVol, cv_NoiseVol;
    std::atomic<int32_t> SawVol, cv_SawVol;
    std::atomic<int32_t> PulseVol, cv_PulseVol;
    std::atomic<int32_t> OSCmix, cv_OSCmix;
    std::atomic<int32_t> RingOnSaw, trig_RingOnSaw;
    std::atomic<int32_t> RingOnPulse, trig_RingOnPulse;
    std::atomic<int32_t> AMisSquare, trig_AMisSquare;
    std::atomic<int32_t> RingModFreq, cv_RingModFreq;
    std::atomic<int32_t> RingModAmnt, cv_RingModAmnt;
    std::atomic<int32_t> WaveFolder, cv_WaveFolder;
    ...
    std::atomic<int32_t> FilterLeakage, cv_FilterLeakage;
    std::atomic<int32_t> PatternSequencer, trig_PatternSequencer;
    std::atomic<int32_t> ResetSequencer, trig_ResetSequencer;
    std::atomic<int32_t> BjorklundOff, trig_BjorklundOff;
    std::atomic<int32_t> BjorklundPattern, cv_BjorklundPattern;
    std::atomic<int32_t> BjorklundShift, cv_BjorklundShift;
    std::atomic<int32_t> PalindromeOff, trig_PalindromeOff;
    std::atomic<int32_t> PalindromeSelect, cv_PalindromeSelect;
    std::atomic<int32_t> PalindromeRootkey, cv_PalindromeRootkey;
    std::atomic<int32_t> AccentOff, trig_AccentOff;
    std::atomic<int32_t> AccentSync, trig_AccentSync;
    std::atomic<int32_t> AccentDestination, cv_AccentDestination;
    std::atomic<int32_t> AccentBeatDivider, cv_AccentBeatDivider;
    std::atomic<int32_t> AccentIsBjorklund, trig_AccentIsBjorklund;
    std::atomic<int32_t> AccentSelect, cv_AccentSelect;
    std::atomic<int32_t> AccentShift, cv_AccentShift;
    std::atomic<int32_t> AccentAmount, cv_AccentAmount;
    std::atomic<int32_t> EGvolActive, trig_EGvolActive;
    std::atomic<int32_t> EGvolNegative, trig_EGvolNegative;
    std::atomic<int32_t> VolAttack, cv_VolAttack;
    std::atomic<int32_t> VolDecay, cv_VolDecay;
    std::atomic<int32_t> VolEnvAmount, cv_VolEnvAmount;
    std::atomic<int32_t> EGvolLoop, trig_EGvolLoop;
    std::atomic<int32_t> EasyEditOn, trig_EasyEditOn;
    std::atomic<int32_t> EGnoiseActive, trig_EGnoiseActive;
    std::atomic<int32_t> EGnoiseNegative, trig_EGnoiseNegative;
    std::atomic<int32_t> NoiseAttack, cv_NoiseAttack;
    std::atomic<int32_t> NoiseDecay, cv_NoiseDecay;
    std::atomic<int32_t> NoiseEnvAmount, cv_NoiseEnvAmount;
    std::atomic<int32_t> EGnoiseLoop, trig_EGnoiseLoop;
    std::atomic<int32_t> EGoscMixActive, trig_EGoscMixActive;
    std::atomic<int32_t> EGoscMixNegative, trig_EGoscMixNegative;
    std::atomic<int32_t> OscMixAttack, cv_OscMixAttack;
    std::atomic<int32_t> OscMixDecay, cv_OscMixDecay;
    std::atomic<int32_t> OscMixEnvAmount, cv_OscMixEnvAmount;
    std::atomic<int32_t> EGoscMixLoop, trig_EGoscMixLoop;
    std::atomic<int32_t> EGringActive, trig_EGringActive;
    std::atomic<int32_t> EGringNegative, trig_EGringNegative;
    std::atomic<int32_t> RingAttack, cv_RingAttack;
    std::atomic<int32_t> RingDecay, cv_RingDecay;
    std::atomic<int32_t> RingAmount, cv_RingAmount;
    std::atomic<int32_t> EGringLoop, trig_EGringLoop;
    std::atomic<int32_t> EGwfActive, trig_EGwfActive;
    std::atomic<int32_t> EGwfNegative, trig_EGwfNegative;
    std::atomic<int32_t> WfAttack, cv_WfAttack;
    std::atomic<int32_t> WfDecay, cv_WfDecay;
    std::atomic<int32_t> WfEnvAmount, cv_WfEnvAmount;
    std::atomic<int32_t> EGwfLoop, trig_EGwfLoop;
    std::atomic<int32_t> EGfiltActive, trig_EGfiltActive;
    std::atomic<int32_t> EGfiltNegative, trig_EGfiltNegative;
    std::atomic<int32_t> FiltAttack, cv_FiltAttack;
    std::atomic<int32_t> FiltDecay, cv_FiltDecay;
    std::atomic<int32_t> FiltAmount, cv_FiltAmount;
    std::atomic<int32_t> EGfiltLoop, trig_EGfiltLoop;
    std::atomic<int32_t> EGfilterLeakActive, trig_EGfilterLeakActive;
    std::atomic<int32_t> EGfilterLeakNegative, trig_EGfilterLeakNegative;
    std::atomic<int32_t> FilterLeakAttack, cv_FilterLeakAttack;
    std::atomic<int32_t> FilterLeakDecay, cv_FilterLeakDecay;
    std::atomic<int32_t> FilterLeakEnvAmount, cv_FilterLeakEnvAmount;
    std::atomic<int32_t> FilterLeakEnvLoop, trig_FilterLeakEnvLoop;
    // sectionHpp
};
