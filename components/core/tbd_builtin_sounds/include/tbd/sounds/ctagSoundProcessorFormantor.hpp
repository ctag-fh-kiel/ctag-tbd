...
protected:
    ...
    std::atomic<int32_t> VoicesDirectOut, trig_VoicesDirectOut;
    std::atomic<int32_t> PDPitch, cv_PDPitch;
    std::atomic<int32_t> PDTune, cv_PDTune;
    std::atomic<int32_t> PDpitchMod, cv_PDpitchMod;
    std::atomic<int32_t> PDamount, cv_PDamount;
    std::atomic<int32_t> WaveFolder, cv_WaveFolder;
    std::atomic<int32_t> SQWPitch, cv_SQWPitch;
    std::atomic<int32_t> SQWTune, cv_SQWTune;
    std::atomic<int32_t> PWMspeed, cv_PWMspeed;
    std::atomic<int32_t> PWMintensity, cv_PWMintensity;
    std::atomic<int32_t> AMon, trig_AMon;
    std::atomic<int32_t> PDaMod, cv_PDaMod;
    std::atomic<int32_t> SQWaMod, cv_SQWaMod;
    std::atomic<int32_t> PDvol, cv_PDvol;
    std::atomic<int32_t> SQWvol, cv_SQWvol;
    std::atomic<int32_t> FormantFilterOn, trig_FormantFilterOn;
    std::atomic<int32_t> KeyLogic, trig_KeyLogic;
    std::atomic<int32_t> FormantSelect, cv_FormantSelect;
    std::atomic<int32_t> FormantRndNew, trig_FormantRndNew;
    std::atomic<int32_t> FormantAmount, cv_FormantAmount;
    std::atomic<int32_t> ResCombOn, trig_ResCombOn;
    std::atomic<int32_t> ResFreq, cv_ResFreq;
    std::atomic<int32_t> ResTone, cv_ResTone;
    std::atomic<int32_t> ResQ, cv_ResQ;
    std::atomic<int32_t> ResAmount, cv_ResAmount;
    std::atomic<int32_t> TremoloActive, trig_TremoloActive;
    std::atomic<int32_t> TremoloGateTrigger, trig_TremoloGateTrigger;
    std::atomic<int32_t> TremoloAttack, cv_TremoloAttack;
    std::atomic<int32_t> TremoloRelease, cv_TremoloRelease;
    std::atomic<int32_t> TremoloIsSQW, trig_TremoloIsSQW;
    std::atomic<int32_t> TremoloSpeed, cv_TremoloSpeed;
    std::atomic<int32_t> TremoloAmount, cv_TremoloAmount;
    std::atomic<int32_t> TremoloAfterResonator, trig_TremoloAfterResonator;
    std::atomic<int32_t> TremoloPDisSQW, trig_TremoloPDisSQW;
    std::atomic<int32_t> TremoloPDAmount, cv_TremoloPDAmount;
    std::atomic<int32_t> TremoloResAmount, cv_TremoloResAmount;
    std::atomic<int32_t> TremoloSnHpd, cv_TremoloSnHpd;
    std::atomic<int32_t> EGvolActive, trig_EGvolActive;
    std::atomic<int32_t> Attack, cv_Attack;
    std::atomic<int32_t> Decay, cv_Decay;
    std::atomic<int32_t> ADSRon, trig_ADSRon;
    std::atomic<int32_t> Sustain, cv_Sustain;
    std::atomic<int32_t> Release, cv_Release;
    std::atomic<int32_t> EGvolSlow, trig_EGvolSlow;
    std::atomic<int32_t> EnvPDamount, cv_EnvPDamount;
    // sectionHpp
};
