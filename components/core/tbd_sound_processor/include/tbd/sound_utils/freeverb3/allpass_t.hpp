...
public:
    ...
    void setsize(_fv3_float_t *buf, const uint32_t size);
...
public:
    ...
    void setsize(_fv3_float_t *buf, const uint32_t size, const uint32_t modsize);
    ...
    inline _fv3_float_t operator()(_fv3_float_t input, _fv3_float_t modulation, _fv3_float_t fmod) {
        return process(input, modulation, fmod);
    }
...
public:
     ...
     */
    void setsize(int32_t size1, int32_t size2);
     ...
     * @return The signal value (z^(-index)).
     */
    inline _fv3_float_t _get_z1(int32_t index) {
#ifdef DEBUG
        if(index > bufsize1||index <= 0) std::fprintf(stderr, "allpass2::_get_z(%ld,%ld)!\n", index, bufsize1);
#endif
        int32_t readpoint = bufidx1 - index;
     ...
     * @return The signal value (z^(-index)).
     */
    inline _fv3_float_t _get_z2(int32_t index) {
#ifdef DEBUG
        if(index > bufsize2||index <= 0) std::fprintf(stderr, "allpass2::_get_z(%ld,%ld)!\n", index, bufsize2);
#endif
        int32_t readpoint = bufidx2 - index;
    ...
    inline _fv3_float_t _process(_fv3_float_t input) {
        ...
        bufidx1++;
        if (bufidx1 >= bufsize1) bufidx1 = 0;
        bufidx2++;
        if (bufidx2 >= bufsize2) bufidx2 = 0;
        return output;
    }
...
private:
    ...
    int32_t bufsize1, bufidx1, bufsize2, bufidx2;
};
...
public:
    ...
    void setsize(int32_t size1, int32_t size2, int32_t size3);

    void setsize(int32_t size1, int32_t size1mod, int32_t size2, int32_t size3);
...
#endif
        int32_t readpoint = readidx1 - index;
        if (readpoint < 0) readpoint += bufsize1;
        return buffer1[readpoint];
    }
    ...
    inline _fv3_float_t _get_z3(int32_t index) {
#ifdef DEBUG
        if(index > bufsize3||index <= 0) std::fprintf(stderr, "allpass3::_get_z(%ld,%ld)!\n", index, bufsize3);
#endif
        int32_t readpoint = bufidx3 - index;
    ...
    inline _fv3_float_t _process(_fv3_float_t input) {
        ...
        writeidx1++;
        if (writeidx1 >= bufsize1) writeidx1 = 0;
        readidx1++;
        if (readidx1 >= bufsize1) readidx1 = 0;
        bufidx2++;
        if (bufidx2 >= bufsize2) bufidx2 = 0;
        bufidx3++;
        if (bufidx3 >= bufsize3) bufidx3 = 0;
        return output;
    }
...
private:
    ...
    int32_t bufsize1, readidx1, writeidx1, bufsize2, bufidx2, bufsize3, bufidx3, modulationsize;
};
