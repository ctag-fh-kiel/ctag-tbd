...
void FV3_(progenitor)::resetdecay() {
    ...
    //decay_ = tbd::sound_utils::powf_fast(10.0f, tbd::sound_utils::fast_log10(decay0) / rt60L);
    decay_ = powf(10.0f, tbd::sound_utils::fast_log10(decay0) / rt60L);

    loopdecay = decay_;
    //printf("decay_ from decay0 %f\n", decay_);

    //decay_ = std::pow((fv3_float_t) 10.0, std::log10(decay1) / rt60s);
    //decay_ = tbd::sound_utils::powf_fast(10.0f, tbd::sound_utils::fast_log10(decay1) / rt60s);
    decay_ = powf(10.0f, tbd::sound_utils::fast_log10(decay1) / rt60s);
    ...
    //decay_ = tbd::sound_utils::powf_fast(10.0f, tbd::sound_utils::fast_log10(decay2) / rt60s);
    decay_ = powf(10.0f, tbd::sound_utils::fast_log10(decay2) / rt60s);
    ...
    //decay_ = tbd::sound_utils::powf_fast(10.0f, tbd::sound_utils::fast_log10(decay3) / rt60s);
    decay_ = powf(10.0f, tbd::sound_utils::fast_log10(decay3) / rt60s);
