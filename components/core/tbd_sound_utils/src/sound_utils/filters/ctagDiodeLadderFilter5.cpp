...
void tbd::sound_utils::ctagDiodeLadderFilter5::Init() {
    int i;
...
float tbd::sound_utils::ctagDiodeLadderFilter5::Process(float in) {
...
void tbd::sound_utils::ctagDiodeLadderFilter5::SetCutoff(float cutoff) {
    cutoff_ = cutoff;
    float T = 1.f / fs_;
    float Tdiv2 = T / 2.0f;
...
void tbd::sound_utils::ctagDiodeLadderFilter5::SetResonance(float resonance) {
    resonance_ = resonance;
    kval_ = resonance * 16.5f;
    calcLowShelveBoost();
}

void tbd::sound_utils::ctagDiodeLadderFilter5::SetSampleRate(float fs) {
    fs_ = fs;
}

void tbd::sound_utils::ctagDiodeLadderFilter5::SetGain(float gain) {
    ctagFilterBase::SetGain(gain);
    calcLowShelveBoost();
}

void tbd::sound_utils::ctagDiodeLadderFilter5::calcLowShelveBoost() {
