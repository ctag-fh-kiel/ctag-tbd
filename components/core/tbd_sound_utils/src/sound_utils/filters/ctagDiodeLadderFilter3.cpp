...
void tbd::sound_utils::ctagDiodeLadderFilter3::SetCutoff(float cutoff) {
    b_fenv = cutoff / fs_;
}

void tbd::sound_utils::ctagDiodeLadderFilter3::SetResonance(float resonance) {
    b_fres = resonance * 10.f;
}

void tbd::sound_utils::ctagDiodeLadderFilter3::SetSampleRate(float fs) {
    fs_ = fs;
}
...
// Ove Hy Karlsen.
*/
float tbd::sound_utils::ctagDiodeLadderFilter3::Process(float in) {
    float b_v = in;
...
void tbd::sound_utils::ctagDiodeLadderFilter3::Init() {
    b_fres = 0.f;
    b_fenv = 0.5f;
...
void tbd::sound_utils::ctagDiodeLadderFilter3::Debug() {
