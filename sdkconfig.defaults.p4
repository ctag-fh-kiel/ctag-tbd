...
CONFIG_TBD_BBA_CODEC_ES8311=y
# CONFIG_TBD_BBA_CODEC_AIC3254 is not set
...
CONFIG_SP_FIXED_MEM_ALLOC_SZ=114688
...
# CONFIG_ESP_GDBSTUB_SUPPORT_TASKS is not set
# end of GDB Stub
...
# CONFIG_FREERTOS_TIMER_TASK_NO_AFFINITY is not set
...
# CONFIG_SLAVE_CHIPSET_ESP32 is not set
CONFIG_SLAVE_CHIPSET_ESP32C6=y
...
# CONFIG_SDIO_RESET_ACTIVE_LOW is not set
...
#
# 'Component config->Bluetooth Host' must be set to 'NimBLE - BLE only'
#

#
# 'Component config->Bluetooth->Controller' must be disabled
#

#
# 'Component config->Bluetooth->NimBLE Options->Host-controller Transport->Uart Transport' must be disabled
#
...
CONFIG_TINYUSB_TASK_STACK_SIZE=1024
...
# CONFIG_GDBSTUB_SUPPORT_TASKS is not set
